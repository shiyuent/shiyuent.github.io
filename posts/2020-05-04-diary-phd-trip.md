...
与导师協作：關鍵是兩個人的步調要一致，否則会在試探对方底线中浪費時間。

1.	嘗試理解他的观念、思路之后，再做讨论认同与否。以symbolic regression 為例子，為什麼導師执意要使用genetic programming？其優勢是white box而不是artificial neural network一样的black box。以此优点为出发，才有了去进一步symbolic regression的优化算法的动力。不带偏见的思考，会让我能看待问题更全面。
2.	尝试将一件个idea最快最彻底的理解后，再去进行第二件事儿。我现在不是没有ideas，相反的是ideas很多，但不是很会怎么做。
3.	我希求自己能写出Caltech风格的博士论文，algorithm + pseudocode，with desire to test things
4.	information and transformation, striping off the extra stone

从朋友口中我逐渐认清了自己的样貌，会收集信息，但性格上满是局限，总是纠结。
-	心情浮动大，和他人交流时，没有耐心，尤其是会有看不起别人的态度。耐心解释（遇到困难）
-	抱怨很多，想的很多，心态不够静和健康

從混凝土的再生骨料、橋樑檢測、橋樑抗風措施、jet-in-crossflow，再到thermal convection；  項目上沒有連續性，那麼工作的深度上也就太難。總結長期來的學習方式，我總是漂浮著看一個課題，漂浮到百分之七八十的狀態，之後便不再深入；在漂浮的比例中，我會糾結於細節中，搜集大量的輔助材料，卻不會直接的面對項目，思考項目。其中最大的劣勢在糾結細節時候貪多，在深入時不專注。 我的焦慮、攀比、視角的猶豫不定。不傻的我，貪多。如我對instability感興趣、對resolvent operator感興趣、對spectral method感興趣、對machine learning感興趣，卻沒有想過為什麼、沒有在一個project裡面，做到一步一步的論證。我想，興趣是一切的動力，而沒有邏輯的沒有持久的積累，則是這些問題的關鍵。懷疑，我懷疑一切，卻不能不相信數學和物理，不能不相信我之前的基礎知識。我要在自負和懷疑之間找到最佳的平衡點。而我又想寫一篇全是數學推導的博士論文，故我要心靜的向前做這些事情。
...
- 生存成本（水果、飯、房租水電網、交通）
    * 在外飲食，中餐每每餐A$13、pizza每餐A$5、KFC每餐A$10； 水果每週 A$20。 總共A$450/月。
    * 房租 A$900(包括搬家成本) 水電煤 A$50 手機網絡 A$50。總計，A$1000/月。
    * 交通 幾乎只靠步行，A$20/月
...
- 自身投資（電腦、手機等）
    * 紐約時報、icloud A$20/月
    * 書籍 A$10/月，個人網站 A$2/月
- 娛樂交際
    * 幾乎不參加， A$18/月
- 其餘
    * A$100/月

獎學金收入： A$2700/月；總支出：A$1300 to 1700/月；結餘，A$1400 to 1000/月
